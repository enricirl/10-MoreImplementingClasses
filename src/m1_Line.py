...
class Line(object):
    ...
    def slope(self):
        ...
        if (self.end.x - self.start.x == 0):
            return math.inf
        value1 = self.end.y - self.start.y
        value2 = self.end.x - self.start.x
        slope_of_line = (value1)/(value2)
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        value = self.start.x + other_line.start.x
        value2 = self.start.y + other_line.start.y
        value3 = self.end.x + other_line.end.x
        value4 = self.end.y + other_line.end.y
        start = Point(value, value2)
        end = Point(value3, value4)
    ...
    def midpoint(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        value = self.end.x/2 + self.start.x/2
        value2 = self.end.y/2 + self.start.y/2
        point = Point(value, value2)
        return point
